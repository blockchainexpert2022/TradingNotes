...
def prendre_screenshot_tradingview(actif):
    ...
    url_tradingview = f"https://fr.tradingview.com/chart/?symbol={actif}&interval=1"
...
def envoyer_image_a_gemini(chemin_image):
    ...
    try:
        ...
        # Prepare the prompt
        prompt = "Analyse selon les concepts avancés du trading ICT et dis simple si c'est valide pour une entré long ou short et si oui alors donne un SL et un TP."
