//+------------------------------------------------------------------+
//|               ICTDailyBiasReversalOrContinuation004-UDUU-DUDD.mq5|
//|                          Copyright 2025, Invest Data Systems FR. |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+

// IN THIS VERSION YOU CAN CHANGE THE showReachedTargets VARIABLE (if false then it will only show non reached targets detected assets)
...
void Ichimoku(string sname)
{
    ...
    )
    {
        ...
        if (showReachedTargets && bTargetReached) printf("ICT DB REVERSAL (U->D) detected for " + sname + " at " + mql_rates[0].close + " target = " + mql_rates[1].low + " " + (bTargetReached?">>> Target has already been reached":""));
        else if (!bTargetReached) printf("ICT DB REVERSAL (U->D) detected for " + sname + " at " + mql_rates[0].close + " target = " + mql_rates[1].low + " " + (bTargetReached?">>> Target has already been reached":""));        
    }
    ...
    )
    {
        ...
        if (showReachedTargets && bTargetReached) printf("ICT DB CONTINUATION (U->U) detected for " + sname + " at " + mql_rates[0].close + " target = " + mql_rates[1].high + " " + (bTargetReached?">>> Target has already been reached":""));
        else if (!bTargetReached) printf("ICT DB CONTINUATION (U->U) detected for " + sname + " at " + mql_rates[0].close + " target = " + mql_rates[1].high + " " + (bTargetReached?">>> Target has already been reached":""));
    }
    ...
    )
    {
        ...
        if (showReachedTargets && bTargetReached) printf("ICT DB REVERSAL (D->U) detected for " + sname + " at " + mql_rates[0].close + " target = " + mql_rates[1].high + " " + (bTargetReached?">>> Target has already been reached":""));
        else if (!bTargetReached) printf("ICT DB REVERSAL (D->U) detected for " + sname + " at " + mql_rates[0].close + " target = " + mql_rates[1].high + " " + (bTargetReached?">>> Target has already been reached":""));
    }
    ...
    )
    {
        ...
        if (showReachedTargets && bTargetReached) printf("ICT DB CONTINUATION (D->D) detected for " + sname + " at " + mql_rates[0].close + " target = " + mql_rates[1].low + " " + (bTargetReached?">>> Target has already been reached":""));
        else if (!bTargetReached) printf("ICT DB CONTINUATION (D->D) detected for " + sname + " at " + mql_rates[0].close + " target = " + mql_rates[1].low + " " + (bTargetReached?">>> Target has already been reached":""));
    }
